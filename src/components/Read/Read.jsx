      ...
      <div className="read">
        ...
        <div className="readRight">
          ...
          {add === 39 && (
            <>
              <h2 className="readRight__title">
                Лекция 15. Сараптамалық жүйелерді жасау технологиясы. Құрастырудың негізгі
                кезеңдері.
              </h2>
              <p>
                <p>
                  <b>1. Лекция мақсаты мен міндеттері:</b> Сараптамалық жүйелерді жасау технологиясы
                  жайлы түсінік беру
                </p>
                <h3>2. Лекция мазмұны:</h3>
                <li> 1. Сараптамалық жүйелерді жасау технологиясы. </li>
                <li> 2. Құрастырудың негізгі кезеңдері.</li>
                <p>
                  <b>3. Оқытудың техникалық құралдары:</b> Zoom онлайн оқыту платформасы
                </p>
                <p>
                ...
                <p>
                  Дәстүрлі бағдарламалық қамсыздандыру типтерін жасау технологиясы: талаптарды
                  талдау, жобалау, бағдарламалау және күйге келтіру, тестілеу кезеңдерінен тұрады.
                  Интеллектуалды жүйені жасау технологиясын жүзеге асыруында бір қатар ерекшеліктері
                  болады (15.1-кесте).
                </p>
                <p>
                  Кестеден көрініп тұр – бірнеше жаңа кезеңдер пайда болады. Барлық кезеңдерді толық
                  қарастырайық.
                </p>
                <p>
                  1. Талаптарды талдау арқасында негізгі ішкі мәндер және олардың арасындағы мүмкін
                  болатын өзара байланыстар анықталады. Бұл кезеңде кәдімгі сұраныстар және оларды
                  қолдану шектері ескертіледі. Мысалы, тұрғындарға қызмет ету орталығының деректер
                  қорына негізделіп, СЖ туысқандық байланысты талдап, «туыс ағайындарды» табу білу
                  керек.
                </p>
                <p>
                  2. Заттық саланың талдауы барлық мүмкін ішкі мәндер мен олардың арасындағы
                  арақатынастарды қарыстыруды, заттық саланың шектеуін және ішкі мәндер мен
                  арақатынастардың мүмкін болатын типтерін математикалық бейнелеуін орындайды.
                  Мысалы, тұрғындарға қызмет ету орталығының деректер қорында мүмкін болатын ішкі
                  мәндер: «еркек», «әйел», «үй», «пәтер», «көше». Арақатынастар: «күйеу», «зайып»,
                  «қызы», «ұл», «іні», «күйеу бала» және т.б. Нақтылау дәрежесі СЖ мүмкіндіктерін
                  анықтайды.
                </p>
                <h3 style={{ textAlign: 'center' }}>Сараптамалық жүйенің жасау кезеңдері</h3>
                <p style={{ textAlign: 'center', margin: '15px 0 ' }}>
                ...
                <p>
                  3. СЖ жобалауы СЖ құрылымының жасауын шақырады. СЖ жобалауының мәнді ерекшелігі –
                  құрылымның таңдап алынған білімдерді ұсыну моделіне тәуелсіздігінде. Мысалы,
                  негізгі өнімдік модельдің таңдауы автоматты түрде ережелер редакторын; фреймдық
                  модельдің таңдауы – объектілер редакторын; ықтималдық модельдің таңдауы – ықтимал
                  редакторын пайдалануды білдіреді. Барлық үш жағдайда білімдер қорының редакторы
                  қажет, бұл СЖ кейбір абстракты құрылымын көрсетуге мүмкіндік береді (15.2-сурет)
                </p>
                <p style={{ textAlign: 'center', margin: '15px 0 ' }}>
                  <img src="img/img99.png" alt="" />
                  <li>
                    <b>15.2-сурет.</b> Абстракты СЖ құрылымы
                  </li>
                </p>
                <p>Сонымен СЖ жұмыс механизмін келесі қадамдармен бейнелеуге болады:</p>
                <li>1. Білім бойынша инженер білімдер қорын (БҚ) толтырды (СЖ оқытты);</li>
                <li>2. Пайдаланушы жүйеге сұрақ қойды;</li>
                <li>
                  3. Интеллектуалды интерфейс сұрақты дәлелдеді және шығару машина үшін мақсатты
                  тұжырымдады;
                </li>
                <li>
                  4. БҚ алынған білімдер негізінде, қойылған мақсатқа жету үшін машина талаптанды;
                </li>
                <li>5. Мәліметтер кемді болғандықтан мақсатқа жетпеді;</li>
                <li>
                  6. Техникалық жүйенің интеллектуалды интерфейсы сәйкес мәліметтер көзімен
                  байланысты;
                </li>
                <li>7. Шығару машина мақсатқа жетуді қайтадан талаптанды;</li>
                <li>8. Қайшы қорытындылар алғандықтан мақсатқа жетпеді;</li>
                <li>9. Пайда болған қайшыларды шешу үшін өз өзін оқыту механизм қосылды;</li>
                <li>
                  10. Өз-өзін оқыту механизмнің жұмыс барысында алынған жаңа білімдер, БҚ
                  редакторына түсті;
                </li>
                <li>
                  11. Білім бойынша инженер жаңа білімдер мен фактілерді қабылдады не қабылдамады;
                </li>
                <li>12. Жаңа білімдер мен фактілер ДҚ және БҚ енгізілді;</li>
                <li>13. 4 пунктке қайту.</li>
                <p>
                  СЖ басқа бағдарламалық құралдардан басты айырмашылығы – бұл білімдер қорының бар
                  болуы, оның ішінде білімдер кейбір білімдерді ұсыну тілде (БҰТ) жазулар жиынтығы
                  түрінде сақталынады. БҰТ мамандарға (сараптамалық жүйені әзірлеуші) түсінікті
                  нысанда білімдер қорын оңай өзгертуге және толықтыруға мүмкіндік береді. Соңғы
                  уақытқа дейін СЖ жасауда орталық проблемасы әртүрлі БҰТ болатын. Қазір білімді
                  ұсынудың ондаған тілі немесе моделі бар. Ең үлкен тараған келесі модельдер:
                  өнімдер, семантикалық желі, фреймдер, 1 ретті предикаттарды есептеу,
                  объектбағытталған тілдер және т.б. Модельдің таңдауы нақты заттық салада
                  білімдердің құрылымымен анықталады. Білімдер қорын жасау және БҰТ таңдау алдында
                  құрылымды анықтау жүргізіледі. Білімдер элементің негіздеу және нақтылау заттық
                  саланың мамандары (сарапшы) тікелей көмегімен жүзеге асырылады. Бұл процесс
                  білімдерді үзінді алу (шығару) деп аталады. Білімдерді шығару мен және құрылымдау
                  мен айналысатын сараптамалық жүйені әзірлеушілерді білімдер бойынша инженерлер деп
                  атайды.
                </p>
                <p style={{ textAlign: 'center', margin: '15px 0 ' }}>
                  <img src="img/img100.png" alt="" />
                  <li>
                    <b>15.3-сурет.</b> СЖ құрастыру мысал циклы
                  </li>
                </p>
              </p>
            </>
          ...
          {add === 40 && (
            <>
              <h2 className="readRight__title">Кейбір тәжірибелік ұсыныстар</h2>
              <p>
                <p>
                  Сараптамалық жүйені әзірлеу дәстүрлі бағдарламаны жасаудан бірнеше рет қиын.
                  Сондықтан:{' '}
                </p>
                <p>- есепті дәстүрлі әдістермен шешуге болатынын;</p>
                <p>- есепті шешу қажеттілігі жиі пайда болмайтынын дәлелдеу қажет</p>
                <p>
                  Тәжірибелі инженер осы бекітулерді қандай да проблемаға қатысты көрсете алады.{' '}
                </p>
                <p>Ал сіздің қарсылыстарыңыз: </p>
                <p>
                  - кірістік мәліметтерде шу мен қайшылықтарды автоматты түрде айырып тану
                  қажеттілігі;
                </p>
                <p>- көп сан параметрлерді еске алу;</p>
                <p>
                  - сарапшы қолдайтың шешімді қабылдау әдістердің (эвристика) қарапайымдығы сияқты
                  дәлелдерді келтіруі мүмкін.
                </p>
                <p>
                  Бірақ, оларға сенбеңіз. Егер шудың автоматты айырып тануы шынында оңай жүзеге
                  асырылса, 2 мен 3 есептерді шешу мүмкін емес.{' '}
                </p>
                <p>
                  Дұрыс келіс – басынан өте қысаң есепті таңдау. Оның шешімі тұнық, түсінікті және
                  бірнеше белгілі әдістерге сәйкес.
                </p>
                <p>
                  Сосын Сіздің бағдарламаңызды қолдайтын пайдаланушыны табу керек. Оны бірдемеге
                  үйрету керек.
                </p>
                <p>
                  Енді Сізбен жұмыс істейтін сарапшыны табу керек. Бірақ, Сіз емес сарапшы Сізді
                  іздеу керек.{' '}
                </p>
                <p>
                  СЖ жасауының келесі кезеңінде түп тұлғаны немесе түп тұлғалық жүйені құру қажет.
                  Осы кезде минималды шығын ережесін сақтау керек. Түп тұлғаны жасауға және енгізуге
                  көп уақыт пен қаражатты жұмсамау керек.{' '}
                </p>
                <p>
                  Түп тұлғалық жүйе фактілер мен байланыстардың кодтау дұрыстығын тексеруге арналған
                  СЖ қысқартылған версиясы болып табылады. Оның көлемі – бірнеше ондаған ережелер,
                  фреймдер немесе мысалдар.
                </p>
                <p>
                  Сосын, егер құптауға болатын түп тұлға жасалынса, жүйенің негізгі жұмыс
                  тәртіптерін толық жетілдіру қажет. Ол үшін қосымша фактілер мен ережелерді енгізу
                  керек, яғни өнеркәсіптікке дейін пысықтау. Бастапқы кодтар, әдетте, қайтадан
                  жазылады. Егер бұрынғы кезеңдерде «бос СЖ» пайдаланса, онда кейбір қажетті
                  модульдерді қосып жазады (15.3-сурет).
                </p>
                <h3>5. Деңгейлік тапсырмалар:</h3>
                <h3>1-деңгей.</h3>
                <li>
                  <b>•</b> Сараптамалық жүйелерді жасау технологиясы;
                </li>
                <h3>2-деңгей. </h3>
                <li>
                  <b>•</b>Сараптамалық жүйелерді құрастыру жолдары;
                </li>
                <h3>3-деңгей. </h3>
                <li>
                  <b>•</b> Сараптамалық жүйелерді құрастырудың негізгі кезеңдері;
                </li>
                <h3>6. БОӨЖ тапсырмалары:</h3>
                <li>Квадраттық бағдарламалау мәселесі және қос есеп.</li>
                <h3>7. БӨЖ тапсырмалары:</h3>
                <li>
                  Нейрондық желілер. Розенблатт Перцептрон. Белсендіру функциялары. Кері тарату
                  градиент. Softmax.
                </li>
                <h3>8. Пайдаланылған әдебиеттер:</h3>
                <li>
